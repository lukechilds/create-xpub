...
const tpubTestParams = {
	...xpubTestParams,
	network: TPUB
};
const xpubCompressedPublicKeyTestParams = {
	...xpubTestParams,
...
test('Different networks can be passed in', t => {
	const tpub = createXpub(tpubTestParams);
...
test('Handles compressed or uncompressed public key', t => {
	...
	const xpubCompressedKey = createXpub(xpubCompressedPublicKeyTestParams);
